...
## Idler:
Idler gears are used to space a reduction differently or to invert the direction of rotation. The gear in the center is the idler gear and makes no difference
## Extruder:
the part of the 3D printer that ejects material in liquid or semi-liquid form in order to deposit it in successive layers within the 3D printing volume
## Motor:
